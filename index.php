...
?>">OCS</a>
  ...
  Conversor dinâmico de HTML-&gt;RSS
  <br /><br />

  <a href="<?echo $local; ?>/rss2js/">RSS2JS</a><br />
  Conversor dinâmico de RSS-&gt;JavaScript
  <br /><br />
...
<div id="mainClm">
  ...
  <p>
    Há <i>RSS readers</i> em vários sistemas operacionais. Um que recomendamos é o <a href="http://www.feedreader.com/">Feedreader</a>, disponível para usuários do Windows.  
  ...
  <ul>
    ...
    <li><a href="<?echo $local; ?>/source.php?b2xml.php">RSS para o b2</a>: permite a geração de RSS para o sistema de gerenciamento de conteúdo <a href="http://cafelog.com/">b2</a><br />
    </li>
  </ul>
  ...
  <ul>
    ...
    <li>13/05/2002: <a href="<?echo $local; ?>/imprensa/20020513-webinsider.htm">RSS busca conteúdo sem roubar pageviews</a> <font size=-3>[ <a href="http://www.webinsider.com.br/vernoticia.php?id=1269">Webinsider</a> ]</font> </li>
    <li>06/05/2002: <a href="<?echo $local; ?>/imprensa/20020506-gildot.htm">Gildot foi RSSficado e muitos outros sites também!</a> <font size=-3>[ <a href="http://www.gildot.org/article.pl?sid=02/05/06/1827240">Gildot</a> ]</font> </li>
    <li>24/04/2002: <a href="<?echo $local; ?>/imprensa/20020424-comunique-se.htm">RSS e Feedreader: lidando com a overdose de informação</a> <font size=-3>[ <a href="http://www.comunique-se.com.br/NewsClip/JornalismoOnline.asp?op2=2&op3=5&Editoria=135">Comunique-se</a> ]</font> </li>
    ...
    <li>15/04/2002: <a href="<?echo $local; ?>/imprensa/20020415-oglobo.htm">Criatividade Máxima</a> <font size=-3>[ <a href="http://oglobo.globo.com/colunas/ultimas.htm">O Globo</a> ]</font> </li>
    ...
    <li>09/04/2002: <a href="<?echo $local; ?>/imprensa/20020409-hotbits.htm">Projeto RSSficado leva notícias a todos os sites</a> <font size=-3>[ <a href="http://hotbits.hiper.com.br/p1/internet/2002/04/0009">HotBits</a>] </font> </li> 
  </ul>
  <p>
